...
// @downloadURL  https://raw.githubusercontent.com/CN-Aryz/userscripts-monorepo/main/userscripts/douyin-quickcopy/dist/douyin-quickcopy.user.js
// @updateURL    https://raw.githubusercontent.com/CN-Aryz/userscripts-monorepo/main/userscripts/douyin-quickcopy/dist/douyin-quickcopy.meta.js
...
(function () {
  ...
  function getCurrentAwemeId() {
    ...
    if (pathMatch == null ? void 0 : pathMatch[1]) return pathMatch[1];
  ...
  function getMostCompatiblePlayUrl(video) {
    ...
    const urlLists = [];
    urlLists.push((_a = video.play_addr_h264) == null ? void 0 : _a.url_list);
    ...
    for (const rate of mp4H264Rates) {
      urlLists.push((_b = rate.play_addr) == null ? void 0 : _b.url_list);
    }
    urlLists.push((_c = video.play_addr) == null ? void 0 : _c.url_list);
  ...
  function cachePlayableUrl(requestUrl, payload) {
    ...
    if (apiInfo.type === "detail") {
      ...
      const awemeId = apiInfo.url.searchParams.get("aweme_id") || ((_a = response.aweme_detail) == null ? void 0 : _a.aweme_id);
      cacheAwemeVideo(awemeId, (_b = response.aweme_detail) == null ? void 0 : _b.video);
      return;
    }
